...
export function SuvivorW4(props) {
  const survivorW4 = useRef();
  const { nodes, materials, animations } = useGLTF(
    "assets/models/scene3/sobrevivientes/animated-survivorW4.glb");
  const { actions } = useAnimations(animations, survivorW4);
  ...
  return (
    <group ref={survivorW4} {...props} dispose={null}>
      <group name="Scene">
        <group name="Armature">
          <skinnedMesh
            name="EyeLeft"
...
useGLTF.preload("assets/models/scene3/sobrevivientes/animated-survivorW4.glb");
