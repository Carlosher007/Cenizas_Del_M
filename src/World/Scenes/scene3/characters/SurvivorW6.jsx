...
export function SurvivorW6(props) {
  const survivorW6 = useRef();
  const { nodes, materials, animations } = useGLTF(
    "assets/models/scene3/sobrevivientes/animated-survivorW6.glb"
  );
  const { actions } = useAnimations(animations, survivorW6);
//   console.log("animations", actions);

  useEffect(() => {
    const action = actions["turn-wall"];
    action.play();
  }, []);
...
useGLTF.preload("assets/models/scene3/sobrevivientes/animated-survivorW6.glb");
